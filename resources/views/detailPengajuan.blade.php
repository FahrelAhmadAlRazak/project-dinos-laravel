    ...
    <div class="my-2 px-8 pt-6 pb-4 shadow w-full h-full overflow-y-scroll">
        ...
        <form id="konfirmasi">
            ...
            <div class="flex gap-4 sm:w-1/3">
                <a class="w-1/2 bg-admin-secondary hover:opacity-90 py-1 rounded-full text-white text-center" href="/setujuiPengajuan/{{ $pengajuan->id }}">Setujui Pengajuan</a>
                <a  class="w-1/2 bg-admin-secondary hover:opacity-90 py-1 rounded-full text-white text-center"href="/tolakPengajuan/{{ $pengajuan->id }}">Tidak</a>
