...
<div id="content" class="pt-24 px-2 py-4 flex-grow h-screen">
    <div class="my-2 px-8 pt-6 pb-4 shadow w-full h-full overflow-y-scroll">
        ...
        <div class="flex flex-col lg:flex-row lg:gap-2">
            <a class="w-1/4 h-24 bg-admin-secondary hover:opacity-90 py-1 rounded-lg text-white flex items-center justify-center text-2xl font-medium" href="{{ route('show_tambah_pencatatan') }}">Tambah</a>
           
            <a class="w-1/4 h-24 bg-admin-secondary hover:opacity-90 py-1 rounded-lg text-white flex items-center justify-center text-2xl font-medium" href="{{ route('lihatPencatatan') }}">Lihat</a>
